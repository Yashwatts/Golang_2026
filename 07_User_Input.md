...
2. **Passing by Reference (Pointers)**
   ...
   - **Explanation:** If you pass just `firstName`, you are passing a copy of the current value (which is likely empty). By using `&`, you give the function a Pointer to the actual spot in memory, allowing it to update the variable directly.
