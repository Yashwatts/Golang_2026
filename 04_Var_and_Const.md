...
• This tells Go where in the computer's memory the variable is stored so that a function (like fmt.Scan) can write the user's input directly into that specific spot.